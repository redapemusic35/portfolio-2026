...
1. Apply philosophical concepts to real-time philosophical dilemmas in virtual environments.
2. Improve critical reasoning through the cycle of argument $\rightarrow$ choice $\rightarrow$ consequence.
3. Engage with primary texts via in-game debriefs to deepen understanding.
4. Write philosophical reflections on your character’s journey, connecting virtual experiences to real-world philosophical thinking.
5. Achieve a basic understanding of ethical dimensions in philosophy (e.g., Aristotle's *Nicomachean Ethics*, Aquinas' teleology) as simulated in virtual environments.
6. Think independently about perennial human questions, such as living well, through experiential examples.
7. Develop and evaluate arguments (spoken or written) for personal and impersonal positions using in-game scenarios.
